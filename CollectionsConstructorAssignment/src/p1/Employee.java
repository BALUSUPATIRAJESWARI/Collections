...
public class Employee{
	...
	public Employee(String empName, char empGender, double yearsOfExperience, String designation,
	...
	public Employee(String empName, char empGender) {
		super();
		this.empName = empName;
		this.empGender = empGender;
	}

	public Employee(double yearsOfExperience /*String designation double basicSalary*/, String status) {
		super();
		this.yearsOfExperience = yearsOfExperience;
		/*this.designation = designation;*/
		/*this.basicSalary = basicSalary;*/
	...
	public void applyForLWP(Employee emp) {
		status="Inactive";
	...
	public String toString() {
		return "Employee [empName=" + empName + ", empGender=" + empGender + ", yearsOfExperience="
